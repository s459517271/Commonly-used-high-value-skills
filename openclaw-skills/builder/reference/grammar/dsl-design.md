...
**Examples of this going wrong:** Jenkins declarative pipelines that grew a `script { ... }` escape hatch and became full Groovy; Magi's Go template language inside YAML.
...
Six architectures (full catalogue in `reference/grammar/dsl-design.md`):
