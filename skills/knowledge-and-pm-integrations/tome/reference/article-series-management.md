...
Multi-episode series need a lightweight **series bible** to maintain consistency. Store it in `.agents/PROJECT.md` or a dedicated `.agents/tome-article-series-{name}.md`:
...
6. Commit: `feat(tome): publish #09 Forge and update series index`.
...
- [ ] Create series bible in `.agents/PROJECT.md` or `.agents/tome-article-series-{name}.md`
